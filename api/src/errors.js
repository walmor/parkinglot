...
const INVALID_SPOT_STATUS = expectedStatus =>
  new BadRequest(`The spot is not ${expectedStatus} anymore.`);

export { BUILDING_NOT_FOUND, INVALID_ROW_NUMBER, INVALID_COL_NUMBER, INVALID_SPOT_STATUS };
